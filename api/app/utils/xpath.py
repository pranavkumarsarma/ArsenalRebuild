class Players:
    ...
    class Search:
        ...
        POSITION = ".//td[@class='posrela']//tr[2]//text()"
...
class Clubs:
    class Transfers:
        BASE_ARRIVALS = "//div[@class='box'][h2[contains(text(), 'Arrivals')]]"
        BASE_DEPARTURES = "//div[@class='box'][h2[contains(text(), 'Departures')]]"
        ROWS = "//tbody//tr[@class='odd' or @class='even']"
        PLAYER_HREF = ".//td[2]//td[@class='hauptlink']//a/@href"
        PLAYER_NAME = ".//td[2]//td[@class='hauptlink']//a/@title"
        PLAYER_POSITION = ".//td[2]//table//tr[2]//td[not(img)]//text()"
        AGE = ".//td[@class='zentriert'][1]//text()"
        CLUB_HREF = ".//td[5]//td[@class='hauptlink']//a/@href"
        CLUB_NAME = ".//td[5]//td[@class='hauptlink']//a/@title"
        FEE = ".//td[@class='rechts hauptlink']//text()"
        SUMMARY_INCOME_COUNT = "//tr[@class='transfer-record__revenue']//td[2]//text()"
        SUMMARY_INCOME_TOTAL = "//tr[@class='transfer-record__revenue']//td[contains(@class,'transfer-record__total')]//text()"
        SUMMARY_EXPENDITURE_COUNT = "//tr[@class='transfer-record__expenses']//td[2]//text()"
        SUMMARY_EXPENDITURE_TOTAL = "//tr[@class='transfer-record__expenses']//td[contains(@class,'transfer-record__total')]//text()"
        SUMMARY_BALANCE = "//tfoot//td[contains(@class,'transfer-record__total')]//text()"
