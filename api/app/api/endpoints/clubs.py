...
@router.get("/{club_id}/transfers", response_model=schemas.ClubTransfers, response_model_exclude_none=True)
def get_club_transfers(club_id: str, season_id: str) -> dict:
    tfmkt = TransfermarktClubTransfers(club_id=club_id, season_id=season_id)
    club_transfers = tfmkt.get_club_transfers()
